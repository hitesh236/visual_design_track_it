...
export function ExecutiveCard({ executive, id }: ExecutiveCardProps) {
  ...
  return (
    <section id={id} className="exec-card-root">
      <style>{`
        /* ── Desktop layout ─────────────────────────── */
        .exec-card-root {
          display:         flex;
      ...
      {/* Mobile Message Shadow */}
      <style>{`
        @media (max-width: 640px) { .exec-msg-desktop { display: none !important; } }
        @media (min-width: 641px) { .exec-msg-mobile  { display: none !important; } }
      `}</style>
      ...
      <div className="exec-card-right">
        <div className="exec-card-buttons">
          <a href={`tel:${executive.phone}`} className="exec-btn" style={{ backgroundColor: 'var(--color-primary)', color: 'var(--color-text-on-primary)' }}>
            <PhoneIcon /> Call Now
          </a>
          <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="exec-btn" style={{ backgroundColor: '#25D366', color: '#ffffff' }}>
            <WhatsAppIcon /> WhatsApp
          </a>
          <a href={`mailto:${executive.email}`} className="exec-btn exec-btn-email" style={{ backgroundColor: 'transparent', border: '1.5px solid var(--color-primary)', color: 'var(--color-primary)' }}>
            <MailIcon /> Send Email
          </a>
        </div>
