      ...
      >
        ...
        >
          ...
          {hasLogo ? (
            ...
            /* Show initials ONLY if name is presence and no logo */
            <div
              style={{
                width:           '52px',
                height:          '52px',
          ...
          {/* Info cluster: Only render if name, address, or chips are present */}
          {(hasName || hasAddr || hasPhone || hasEmail || hasWebsite) && (
            ...
            >
              ...
              {/* Contact chips: Independently rendered */}
